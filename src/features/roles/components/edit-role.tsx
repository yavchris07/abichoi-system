...
const EditRole = ({ open, onClose,role }: editRoleProps) => {
  const token = getToken();
  const { editRole, fail, pending } = useEditRole(token ?? "");
